...
pub fn compare_packages_by_name_test() {
  let a =
    ResolvedPackage(name: "alpha", version: "1.0.0", registry: Hex, sha256: "a")
  let b =
    ResolvedPackage(name: "beta", version: "1.0.0", registry: Hex, sha256: "b")
...
pub fn compare_packages_same_name_different_registry_test() {
  let hex_pkg =
    ResolvedPackage(name: "utils", version: "1.0.0", registry: Hex, sha256: "h")
  let npm_pkg =
    ResolvedPackage(name: "utils", version: "2.0.0", registry: Npm, sha256: "n")
  // "hex" < "npm" 사전순
